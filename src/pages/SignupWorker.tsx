    ...
    <PublicLayout>
      <section className="container max-w-md py-12 md:py-20">
        ...
        <div className="mt-8 rounded-lg border border-success/30 bg-success/10 p-4 text-sm flex gap-3">
          ...
          <div>
            <p className="font-bold text-foreground">Free to join. Your rating sets your rate.</p>
            <p className="text-muted-foreground mt-1">No application fees, no subscriptions. New workers start at a 5% platform cut on completed jobs — earn it down to as low as 2% with great ratings, or up to 10% if reviews go south. Good work means you keep more. <Link to="/pricing" className="text-primary font-semibold">See pricing</Link></p>
          </div>
        </div>
      </section>
    </PublicLayout>
